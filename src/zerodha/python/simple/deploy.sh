...
crontab -e
18 9 * * 1-5 pkill -f algo_trading.py && nohup python3 /home/$USER/algo_trading.py > /home/$USER/output.log 2>&1 &
18 9 * * 1-5 pkill -f algo_trading.py && nohup python3 /workspace/algo_trading.py > /home/$USER/output.log 2>&1 &
tail -f output.log
