...
nohup python3 aas_algo_trading.py > aas_algo_trading_output.log 2>&1 &
ps aux | grep aas_algo_trading.py
printf "Stop the script if needed bt the command: pkill -f aas_algo_trading.py"
...
printf "Manually restart script if needed : "pkill -f aas_algo_trading.py" then type: "nohup python3 aas_algo_trading.py > aas_algo_trading_output.log 2>&1 &""
